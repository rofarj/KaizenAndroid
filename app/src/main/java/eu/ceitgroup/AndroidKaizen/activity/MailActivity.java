...
public class MailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        receiver = intent.getStringExtra("proposalResponsiblePerson");

        buttonEmail = (Button) findViewById(R.id.buttonMail);
        ...
        buttonEmail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sendEmail.putExtra(Intent.EXTRA_STREAM, Uri.parse("file:/sdcard/simpleTable.pdf"));
                //i.putExtra(Intent.EXTRA_STREAM, "zsskCD.pdf");
                sendEmail.putExtra(Intent.EXTRA_EMAIL, new String[] { to });
                sendEmail.putExtra(Intent.EXTRA_SUBJECT, "Kaizen Idea");
                sendEmail.putExtra(Intent.EXTRA_TEXT, "Attached is a Kaizen Idea");
                //i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);

                startActivity(Intent.createChooser(sendEmail, "E-mail"));
