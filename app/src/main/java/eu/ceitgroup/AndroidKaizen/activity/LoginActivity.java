...
public class LoginActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (session.isLoggedIn()) {
            // MainActivity is already logged in. Take him to main activity
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        String department = user.getString("company");
                        String phone = user.getString("phone");
                        String user_type = user.getString("user_type");

                        Log.d("JSONObject for login", "EMAIL: " + email);
                        Log.d("JSONObject for login", "COMPANY: " + department);
                        Log.d("JSONObject for login", "PHONE: " + phone);
                        Log.d("JSONObject for login", "TYPE: " + user_type);
                        Log.d("JSONObject for login", "ID: " + uid);

                        // Inserting row in users table
                        db.addUser(name, email, uid, surname, department, user_type);
